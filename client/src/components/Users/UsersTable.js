        ...
        if (typeBeat !== 3) {
          if (typeBeat !== 2) {
            ...
            try {
              ...
              console.log(err);
              const errMsg =
                err?.data?.error?.data || "Произошла ошибка при смене пароля.";
              dispatch(
                showSnackbar({
                  message: errMsg,
                  severity: "error",
            ...
            try {
              ...
              const errMsg =
                err?.data?.error?.data ||
                "Произошла ошибка при удалении карточки.";
              dispatch(
                showSnackbar({
                  message: errMsg,
                  severity: "error",
      ...
      if (data.get("tmstart") === "" && data.get("tmend") === "") {
        ...
        if (data.get("tmstart") === "" && data.get("tmend") !== "") {
          ...
          try {
            ...
            console.log(err);
            const errMsg =
              err?.data?.error?.data || "Произошла ошибка при смене времени.";
            dispatch(
              showSnackbar({
                message: errMsg,
                severity: "error",
